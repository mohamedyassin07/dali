...
if( !class_exists('DALI_acf_field_dali_hidden') ) :


class DALI_acf_field_dali_hidden extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Dali Hidden', 'dali');
		...
		*  var message = acf._e('dali_hidden', 'error');
		*/
...
// initialize
new DALI_acf_field_dali_hidden( $this->settings );
